class ProjectsController < ApplicationController
  ...
  private
    ...
    def project_params
      params.require(:project).permit(:name, :category, :client, :url, :github,
        :description, :body, :thumbnail, :tag_list, :role_title,
        screenshots_attributes: [:id, :image, :title, :_destroy])
    end
end
